...
namespace Employee_Travel_Booking_MVC.Controllers.Employee
{
    ...
    {
        public Employee_Travel_Booking_SystemDB1Entities1 db = new Employee_Travel_Booking_SystemDB1Entities1();
        ...
        public ActionResult Create([Bind(Include = "reasonfortravel,modeoftransport,hotelneeded,departurecity,arrivalcity,departuredate,departuretime")] travelrequest travelrequest)//, HttpPostedFileBase IdentityProofFile)
        {
